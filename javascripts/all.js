...
;
// $(document).ready(function() {
//   if ($("#js-parallax-window-fs").length) {
//     parallax();
//   }
// });
...
// function parallax(){
//   if( $("#js-parallax-window-fs").length > 0 ) {
//     var plxBackground = $("#js-parallax-background-fs");
//     var plxWindow = $("#js-parallax-window-fs");
...
//     $(".shuffle-grid div").not("."+selectedClass).fadeOut().removeClass('scale-animation');
//     setTimeout(function() {
//     $("."+selectedClass).fadeIn().addClass('scale-animation');
//     $(".shuffle-grid").fadeTo(300, 1);
//     }, 300);
...
//   });
// });
/* http://prismjs.com/download.html?themes=prism&languages=markup+css+clike+javascript+bash+ruby+scss */
